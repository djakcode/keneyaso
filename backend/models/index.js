...
// Pharmacy and Products (One-to-Many)
Pharmacy.hasMany(Product, { foreignKey: "pharmacyId", as: "products" });
Product.belongsTo(Pharmacy, { foreignKey: "pharmacyId", as: "pharmacy" });

// Product and PrescriptionItem (One-to-Many)
Product.hasMany(PrescriptionItem, {
  foreignKey: "productId",
  as: "prescriptionItems",
});
PrescriptionItem.belongsTo(Product, { foreignKey: "productId", as: "product" });

// Product and InvoiceItem (One-to-Many)
